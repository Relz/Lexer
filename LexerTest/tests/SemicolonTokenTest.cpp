...
{
	ExpectTokenInformations(";", { TokenInformation(Token::SEMICOLON, StreamString(";", StreamPosition())) });
}

TEST(semicolon_token, determining_if_stay_between_delimiters)
{
	ExpectTokenInformations(" ; ", { TokenInformation(Token::SEMICOLON, StreamString(";", StreamPosition(1, 2))) });
