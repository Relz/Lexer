...
{
	ExpectTokenInformations("/", { TokenInformation(Token::DIVISION, StreamString("/", StreamPosition())) });
}

TEST(division_token, determining_if_stay_between_delimiters)
{
	ExpectTokenInformations(" / ", { TokenInformation(Token::DIVISION, StreamString("/", StreamPosition(1, 2))) });
	ExpectTokenInformations(
		";/;",
		{ TokenInformation(Token::SEMICOLON, StreamString(";", StreamPosition())),
		  TokenInformation(Token::DIVISION, StreamString("/", StreamPosition(1, 2))),
...
TEST(division_token, determining_if_stay_near_delimiter)
{
	ExpectTokenInformations(
		"/;",
		{ TokenInformation(Token::DIVISION, StreamString("/", StreamPosition())),
...
TEST(division_token, determining_if_stay_between_numbers)
{
	ExpectTokenInformations(
		"1/1",
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::FLOAT, StreamString("1.1", StreamPosition())),
		  TokenInformation(Token::DIVISION, StreamString("/", StreamPosition(1, 4))),
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::EXPONENTIAL, StreamString("1_E+1", StreamPosition())),
		  TokenInformation(Token::DIVISION, StreamString("/", StreamPosition(1, 6))),
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::EXPONENTIAL, StreamString("1.1_E+1", StreamPosition())),
		  TokenInformation(Token::DIVISION, StreamString("/", StreamPosition(1, 8))),
		  TokenInformation(Token::INTEGER, StreamString("1", StreamPosition(1, 9))) });
	ExpectTokenInformations(
		"1.1_E+1/1_E+1",
		{ TokenInformation(Token::EXPONENTIAL, StreamString("1.1_E+1", StreamPosition())),
		  TokenInformation(Token::DIVISION, StreamString("/", StreamPosition(1, 8))),
		  TokenInformation(Token::EXPONENTIAL, StreamString("1_E+1", StreamPosition(1, 9))) });
	ExpectTokenInformations(
		"1.1_E+1/1.1_E+1",
		{ TokenInformation(Token::EXPONENTIAL, StreamString("1.1_E+1", StreamPosition())),
		  TokenInformation(Token::DIVISION, StreamString("/", StreamPosition(1, 8))),
...
TEST(division_token, not_determining_if_part_of_plus_assignment)
{
	...
	ExpectTokenInformations(
		"/=/",
		{ TokenInformation(Token::DIVISION_ASSIGNMENT, StreamString("/=", StreamPosition())),
		  TokenInformation(Token::DIVISION, StreamString("/", StreamPosition(1, 3))) });
}
