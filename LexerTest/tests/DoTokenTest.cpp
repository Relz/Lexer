...
TEST(do_token, not_determining_if_between_numbers)
{
	...
	ExpectTokens("1do1.1", { Token::UNKNOWN, Token::DOT, Token::INTEGER });
	ExpectTokens("1.1do1", { Token::UNKNOWN });
	ExpectTokens("1.1do1.1", { Token::UNKNOWN, Token::DOT, Token::INTEGER });
	ExpectTokens("1_E+1do1", { Token::UNKNOWN });
	ExpectTokens("1do1_E+1", { Token::UNKNOWN, Token::PLUS, Token::INTEGER });
}
