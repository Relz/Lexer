...
TEST(extends_token, not_determining_if_between_numbers)
{
	...
	ExpectTokens("1extends1.1", { Token::UNKNOWN });
	ExpectTokens("1.1extends1", { Token::UNKNOWN });
	ExpectTokens("1.1extends1.1", { Token::UNKNOWN });
	ExpectTokens("1E+1extends1", { Token::UNKNOWN });
	ExpectTokens("1extends1E+1", { Token::UNKNOWN });
}
