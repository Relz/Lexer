...
TEST(more_or_equivalence_token, determining_if_stay_alone)
{
	ExpectTokenInformations(
		">=", { TokenInformation(Token::MORE_OR_EQUIVALENCE, StreamString(">=", StreamPosition())) });
}

TEST(more_or_equivalence_token, determining_if_stay_between_delimiters)
{
	ExpectTokenInformations(
		" >= ", { TokenInformation(Token::MORE_OR_EQUIVALENCE, StreamString(">=", StreamPosition(1, 2))) });
	ExpectTokenInformations(
		";>=;",
...
TEST(more_or_equivalence_token, determining_if_stay_between_numbers)
{
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::FLOAT, StreamString("1.1", StreamPosition())),
		  TokenInformation(Token::MORE_OR_EQUIVALENCE, StreamString(">=", StreamPosition(1, 4))),
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::EXPONENTIAL, StreamString("1_E+1", StreamPosition())),
		  TokenInformation(Token::MORE_OR_EQUIVALENCE, StreamString(">=", StreamPosition(1, 6))),
