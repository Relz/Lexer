...
TEST(implements_token, not_determining_if_between_numbers)
{
	ExpectTokens("1implements1", { Token::UNKNOWN });
	ExpectTokens("1implements1.1", { Token::UNKNOWN });
	ExpectTokens("1.1implements1", { Token::UNKNOWN });
	ExpectTokens("1.1implements1.1", { Token::UNKNOWN });
	ExpectTokens("1E+1implements1", { Token::UNKNOWN });
	ExpectTokens("1implements1E+1", { Token::UNKNOWN });
}
