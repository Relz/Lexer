...
|Число                  |INTEGER             |Значение целого числа                         |```0```          |
|                       |FLOAT               |Значение числа с плавающей запятой            |```0.1```        |
|                       |EXPONENTIAL         |Значение экспоненциального числа              |```0.1E+1```     |
...
|INTEGER             |Последовательность цифр, не заканичивающихся символом '.' или 'E', не являющаяся частью строкового литерала или комментария                                                                                                         |
